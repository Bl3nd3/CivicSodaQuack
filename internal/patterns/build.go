...
func Build(req BuildRequest) (*personal.Draft, error) {
	...
	mode := &personal.Document{
		...
		About: "Assembled with 'csq modes add' from csq's analysis patterns. Every " +
			"query here comes from a reviewed SQL template pointed at columns chosen " +
			"by hand, so nothing in this file was generated by a model and none of it " +
